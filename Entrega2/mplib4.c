...
typedef struct channel_t {
  ...
  pthread_mutex_t    single_mutex;          /*o trinco e as variaveis de condicao agora sao especificos da estrutura do canal
                                           contrariamente a antes que eram variaveis globais para todos os canais*/
...
Channel_t* createChannel () {
  ...
  /*a iniciacao dos trincos e das variaveis de condicao agora e feita cada vez que for criado o canal atraves do createChannel*/
...
void libertarMPlib() {
  ...
  for (i=0; i<number_of_tasks; i++) {
    for (j=0; j<number_of_tasks; j++) {
      ...
      /*agora como existem trincos e variaveis de condicao respetivos de cada canal tera de se destruir todos os trincos e variaveis
       de condicao de todos os canais*/ 
