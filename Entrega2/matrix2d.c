...
double* dm2dGetLine (DoubleMatrix2D *matrix, int line_nb) {  // verifica os valores de uma linha inteira de uma matriz 
...
void dm2dSetLine (DoubleMatrix2D *matrix, int line_nb, double* line_values) {  //altera os valores de uma linha inteira de uma matriz
...
void dm2dSetLineTo (DoubleMatrix2D *matrix, int line, double value) { // altera os valores das colunas de uma linha fixa
  int i;
...
void dm2dSetColumnTo (DoubleMatrix2D *matrix, int column, double value) { // altera os valores das linhas de uma coluna fixa
  int i;
...
void dm2dCopy (DoubleMatrix2D *to, DoubleMatrix2D *from) {    //copia os dados de uma matriz para a outra
...
void dm2dPrint (DoubleMatrix2D *matrix) {    //faz o print da matriz
  int i, j;
